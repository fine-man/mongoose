...
from src.utils import train_lsh
...
model = train_lsh(model, train_loader, criterion, optimizer, test_loader, num_epochs=num_epochs)

# Save the model
savepath = f"{CHECKPOINT_DIR}/mnist_lsh_h{hidden_size}.pt"
